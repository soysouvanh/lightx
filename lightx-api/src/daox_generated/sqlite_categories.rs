...
pub enum SqliteCategoriesOrderBy {
    IdAsc,
    IdDesc,
    NameAsc,
    NameDesc,
...
impl SqliteCategoriesOrderBy {
    pub fn as_str(&self) -> &'static str {
        match self {
            SqliteCategoriesOrderBy::IdAsc => r#"`id` ASC"#,
            SqliteCategoriesOrderBy::IdDesc => r#"`id` DESC"#,
            SqliteCategoriesOrderBy::NameAsc => r#"`name` ASC"#,
            SqliteCategoriesOrderBy::NameDesc => r#"`name` DESC"#,
            SqliteCategoriesOrderBy::ParentIdAsc => r#"`parent_id` ASC"#,
            SqliteCategoriesOrderBy::ParentIdDesc => r#"`parent_id` DESC"#,
        }
    }
}

#[allow(clippy::all)]
impl SqliteCategories {
    ...
    pub async fn estimated_count_upper_bound<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(
        ...
        let query = r#"SELECT MAX(rowid) FROM `categories`"#;
    ...
    pub fn stream_all<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite> + 'e>(
        ...
        let query =
            r#"SELECT `id`, `name`, `parent_id` FROM `categories` ORDER BY `id` ASC LIMIT ?"#;
    ...
    pub async fn get_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(
        ...
        let query = r#"SELECT `id`, `name`, `parent_id` FROM `categories` WHERE `id` = ?"#;
    ...
    pub async fn exists_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(
        ...
        let query = r#"SELECT 1 FROM `categories` WHERE `id` = ? LIMIT 1"#;
    ...
    pub async fn list_by_cursor<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(
        ...
        let limit = limit.clamp(1, 10000);
        let query = r#"SELECT `id`, `name`, `parent_id` FROM `categories` WHERE `id` > ? ORDER BY `id` ASC LIMIT ?"#;
        sqlx::query_as::<_, Self>(query)
            .bind(last_id)
            .bind(limit as i64)
            .fetch_all(executor)
    ...
    pub async fn insert_unchecked<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(
        ...
        let query = r#"INSERT INTO `categories` (`name`, `parent_id`) VALUES (?, ?)"#;
    ...
    pub async fn upsert_unchecked<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(
        ...
        let query = r#"INSERT INTO `categories` (`name`, `parent_id`) VALUES (?, ?) ON CONFLICT (`id`) DO UPDATE SET `name` = EXCLUDED.`name`, `parent_id` = EXCLUDED.`parent_id`"#;
        let result = sqlx::query::<sqlx::Sqlite>(query)
            .bind(&self.name)
            .bind(&self.parent_id)
            .execute(executor)
    ...
    pub async fn update_unchecked_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(
        ...
        let query_str = r#"UPDATE `categories` SET `name` = ?, `parent_id` = ? WHERE `id` = ?"#;
    ...
    pub async fn delete_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(
        ...
        let query = r#"DELETE FROM `categories` WHERE `id` = ?"#;
        let result = sqlx::query::<sqlx::Sqlite>(query)
            .bind(id)
            .execute(executor)
            .await?;
...
pub struct SqliteCategoriesPatch {
