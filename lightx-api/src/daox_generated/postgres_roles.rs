...
pub struct PostgresRoles {
    pub id: i32,
    pub name: String,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum PostgresRolesOrderBy {
    IdAsc,
    IdDesc,
    NameAsc,
    NameDesc,
...
impl PostgresRolesOrderBy {
    pub fn as_str(&self) -> &'static str {
        match self {
            PostgresRolesOrderBy::IdAsc => r#""id" ASC"#,
            PostgresRolesOrderBy::IdDesc => r#""id" DESC"#,
            PostgresRolesOrderBy::NameAsc => r#""name" ASC"#,
            PostgresRolesOrderBy::NameDesc => r#""name" DESC"#,
        }
    }
}
...
impl PostgresRoles {
    ...
    pub fn stream_all<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres> + 'e>(
        ...
        let query = r#"SELECT "id", "name" FROM "roles" ORDER BY "id" ASC LIMIT $1"#;
    ...
    pub async fn get_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(
        ...
        let query = r#"SELECT "id", "name" FROM "roles" WHERE "id" = $1"#;
    ...
    pub async fn exists_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(
        ...
        let query = r#"SELECT 1 FROM "roles" WHERE "id" = $1 LIMIT 1"#;
    ...
    pub async fn list_by_cursor<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(
        ...
        let limit = limit.clamp(1, 10000);
        let query =
            r#"SELECT "id", "name" FROM "roles" WHERE "id" > $1 ORDER BY "id" ASC LIMIT $2"#;
        sqlx::query_as::<_, Self>(query)
            .bind(last_id)
            .bind(limit as i64)
            .fetch_all(executor)
    ...
    pub async fn insert_unchecked<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(
        ...
        let query = r#"INSERT INTO "roles" ("name") VALUES ($1) RETURNING "id"::bigint"#;
    ...
    pub async fn insert_batch<'e>(
        ...
        let mut copy_in = executor
            .copy_in_raw(r#"COPY "roles" ("name") FROM STDIN WITH (FORMAT csv)"#)
            .await?;
    ...
    pub async fn upsert_unchecked<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(
        ...
        let query = r#"INSERT INTO "roles" ("name") VALUES ($1) ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name""#;
    ...
    pub async fn update_unchecked_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(
        ...
        let query_str = r#"UPDATE "roles" SET "name" = $1 WHERE "id" = $2"#;
    ...
    pub async fn delete_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(
        ...
        let query = r#"DELETE FROM "roles" WHERE "id" = $1"#;
        let result = sqlx::query::<sqlx::Postgres>(query)
            .bind(id)
            .execute(executor)
            .await?;
