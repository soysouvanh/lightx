...
impl SqliteGroupsOrderBy {
    pub fn as_str(&self) -> &'static str {
        match self {
            SqliteGroupsOrderBy::IdAsc => r#"`id` ASC"#,
            SqliteGroupsOrderBy::IdDesc => r#"`id` DESC"#,
            SqliteGroupsOrderBy::NameAsc => r#"`name` ASC"#,
            SqliteGroupsOrderBy::NameDesc => r#"`name` DESC"#,
        }
    }
}
...
impl SqliteGroups {
    ...
    pub async fn estimated_count_upper_bound<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(
        ...
        let query = r#"SELECT MAX(rowid) FROM `groups`"#;
    ...
    pub fn stream_all<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite> + 'e>(
        ...
        let query = r#"SELECT `id`, `name` FROM `groups` ORDER BY `id` ASC LIMIT ?"#;
    ...
    pub async fn get_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(
        ...
        let query = r#"SELECT `id`, `name` FROM `groups` WHERE `id` = ?"#;
    ...
    pub async fn exists_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(
        ...
        let query = r#"SELECT 1 FROM `groups` WHERE `id` = ? LIMIT 1"#;
    ...
    pub async fn list_by_cursor<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(
        ...
        let limit = limit.clamp(1, 10000);
        let query = r#"SELECT `id`, `name` FROM `groups` WHERE `id` > ? ORDER BY `id` ASC LIMIT ?"#;
        sqlx::query_as::<_, Self>(query)
            .bind(last_id)
            .bind(limit as i64)
            .fetch_all(executor)
    ...
    pub async fn insert_unchecked<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(
        ...
        let query = r#"INSERT INTO `groups` (`name`) VALUES (?)"#;
    ...
    pub async fn upsert_unchecked<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(
        ...
        let query = r#"INSERT INTO `groups` (`name`) VALUES (?) ON CONFLICT (`id`) DO UPDATE SET `name` = EXCLUDED.`name`"#;
        let result = sqlx::query::<sqlx::Sqlite>(query)
            .bind(&self.name)
            .execute(executor)
            .await?;
    ...
    pub async fn update_unchecked_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(
        ...
        let query_str = r#"UPDATE `groups` SET `name` = ? WHERE `id` = ?"#;
