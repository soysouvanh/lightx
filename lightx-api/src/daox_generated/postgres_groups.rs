...
pub struct PostgresGroups {
    pub id: i32,
    pub name: String,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum PostgresGroupsOrderBy {
    IdAsc,
    IdDesc,
    NameAsc,
    NameDesc,
...
impl PostgresGroupsOrderBy {
    pub fn as_str(&self) -> &'static str {
        match self {
            PostgresGroupsOrderBy::IdAsc => r#""id" ASC"#,
            PostgresGroupsOrderBy::IdDesc => r#""id" DESC"#,
            PostgresGroupsOrderBy::NameAsc => r#""name" ASC"#,
            PostgresGroupsOrderBy::NameDesc => r#""name" DESC"#,
        }
    }
}
...
impl PostgresGroups {
    ...
    pub async fn count<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(
        ...
        let query = r#"SELECT COUNT(*) FROM "groups""#;
    ...
    pub fn stream_all<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres> + 'e>(
        ...
        let query = r#"SELECT "id", "name" FROM "groups" ORDER BY "id" ASC LIMIT $1"#;
    ...
    pub async fn get_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(
        ...
        let query = r#"SELECT "id", "name" FROM "groups" WHERE "id" = $1"#;
    ...
    pub async fn exists_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(
        ...
        let query = r#"SELECT 1 FROM "groups" WHERE "id" = $1 LIMIT 1"#;
    ...
    pub async fn list_by_cursor<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(
        ...
        let limit = limit.clamp(1, 10000);
        let query =
            r#"SELECT "id", "name" FROM "groups" WHERE "id" > $1 ORDER BY "id" ASC LIMIT $2"#;
        sqlx::query_as::<_, Self>(query)
            .bind(last_id)
            .bind(limit as i64)
            .fetch_all(executor)
    ...
    pub async fn insert_unchecked<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(
        ...
        let query = r#"INSERT INTO "groups" ("name") VALUES ($1) RETURNING "id"::bigint"#;
    ...
    pub async fn insert_batch<'e>(
        ...
        let mut copy_in = executor
            .copy_in_raw(r#"COPY "groups" ("name") FROM STDIN WITH (FORMAT csv)"#)
            .await?;
    ...
    pub async fn upsert_unchecked<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(
        ...
        let query = r#"INSERT INTO "groups" ("name") VALUES ($1) ON CONFLICT ("id") DO UPDATE SET "name" = EXCLUDED."name""#;
    ...
    pub async fn upsert_batch<'e>(
        ...
        let chunk_size = 65535 / 1;
        let mut total_affected = 0;
        for chunk in items.chunks(chunk_size.max(1)) {
            let mut qb: sqlx::QueryBuilder<sqlx::Postgres> =
                sqlx::QueryBuilder::new(r#"INSERT INTO "groups" ("name") "#);
    ...
    pub async fn update_unchecked_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(
        ...
        let query_str = r#"UPDATE "groups" SET "name" = $1 WHERE "id" = $2"#;
    ...
    pub async fn delete_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(
        ...
        let query = r#"DELETE FROM "groups" WHERE "id" = $1"#;
        let result = sqlx::query::<sqlx::Postgres>(query)
            .bind(id)
            .execute(executor)
            .await?;
    ...
    pub async fn delete_many_by_id<'e>(
        ...
        for chunk in ids.chunks(chunk_size) {
            let mut qb: sqlx::QueryBuilder<sqlx::Postgres> =
                sqlx::QueryBuilder::new(r#"DELETE FROM "groups" WHERE "id" IN "#);
            qb.push("(");
    ...
    pub async fn update_partial_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(
        ...
        let mut qb: sqlx::QueryBuilder<sqlx::Postgres> =
            sqlx::QueryBuilder::new("UPDATE \"groups\" SET ");
        let mut first = true;
        if let Some(val) = &patch.name {
            if !first {
                qb.push(", ");
...
pub struct PostgresGroupsPatch {
